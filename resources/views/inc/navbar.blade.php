<nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="margin-bottom:10px;">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link" href="/queries/create">Contact Us</a>
      </li> -->
      <li class="nav-item">
        <a class="nav-link" href="events/genMeet">General Meetings</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/events">Schedule a Meeting</a>
      </li>
    </ul>
